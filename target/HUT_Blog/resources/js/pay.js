 ...
 */
	...
	var content = "<div class=\"ds-dialog\" id='PAY_" + id + "'>" +
			...
			"       <img  class=\"qrcode-img qrCode_0\" id=\"qrCode_0\" src=\"resources/img/wechat.jpg\" />" +
			"      </div>" +
			...
			"       <img  class=\"qrcode-img qrCode_1\" id=\"qrCode_1\" src=\"resources/img/qqpay.png\" />" +
			"      </div>" +
			"      <p class=\"qrcode-tip\">打赏</p>" +
			"     </div>" +
			"     <div class=\"qrcode-img qrCode_2\" id=\"qrCode_2\">" +
			"      <div class=\"qrcode-border box-size\" style=\"border: 9.02px solid rgb(235, 95, 1\">" +
			"       <img  class=\"qrcode-img qrCode_2\" id=\"qrCode_2\" src=\"resources/img/alipay.jpg\" />" +
			"      </div>" +
			"      <p class=\"qrcode-tip\">打赏</p>"
