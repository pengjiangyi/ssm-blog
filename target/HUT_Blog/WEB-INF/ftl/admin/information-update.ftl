...
<article class="page-container">
	<form action="" method="get" class="form form-horizontal" id="form-information-update">
	
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>信息id：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${information.id}" placeholder="" id="id" name="id">
			</div>
		</div>
	
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>信息内容：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${information.text}" placeholder="" id="text" name="text">
			</div>
		</div>
...
$(function(){
	...
	$("#form-information-update").validate({
		rules:{
			text:{
				required:true,
		...
		submitHandler:function(form){
				...
				//ajax上传
						$.ajax({
							type: "post",
							url: rootPath + "/admin/updateInformation",
							async: false,
