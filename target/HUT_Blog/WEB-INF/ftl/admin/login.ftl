...
<link rel="stylesheet" type="text/css" href="${request.contextPath}/resources/assets/hui-admin/static/h-ui.admin/css/H-ui.login.css" />
<!--[if IE 6]>
...
<div class="loginWraper">
  <div id="loginform" class="loginBox">
    <form class="form form-horizontal" action="${request.contextPath}/admin/login" method="post">
      <div class="row cl">
...
<div class="footer">Copyright 彭江毅  by H-ui.admin v3.1</div>
<!--_footer 作为公共模版分离出去-->
