...
<article class="page-container">
			...
			<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="${carousel.id}" placeholder="" id="carouselId" name="carouselId">
					</div>
				</div>
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="${carousel.name}" placeholder="" id="name" name="name">
					</div>
				</div>
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9 skin-minimal">
						...
						<input style="width: 90%;" class="input-text" type="text" id="picture" name="cover" value=${carousel.url}><input type="button" onclick="upImage();" class="btn btn-primary radius" value="上传"></input>
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-3">图片简介：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<textarea name="abstract" id="abstract" cols="" rows="" class="textarea" placeholder="说点什么...最少输入10个字符">${carousel.content}</textarea>
